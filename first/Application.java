...
public class Application {
	...
	public static void main(String[] args) {
		...
		Order o1 = new Order(1001,LocalDate.parse("2019-01-07"),2000.00,p1,a1);
		Order o2 = new Order(1002,LocalDate.parse("2019-02-07"),3000.00,p2,a2);
		Order o3 = new Order(1003,LocalDate.parse("2019-03-07"),4000.00,p3,a3);
		Order o4 = new Order(1004,LocalDate.parse("2019-04-07"),5000.00,p4,a4);
		Order o5 = new Order(1005,LocalDate.parse("2019-05-07"),6000.00,p5,a5);
